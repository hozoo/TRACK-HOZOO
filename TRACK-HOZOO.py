...
def main():
	...
	if len(sys.argv) == 2:
		...
		print (color.BLUE + "[+] " + color.END + "informasi nomor HP!!")
		print ("--------------------------------------")
		time.sleep(0.2)
...
time.sleep(0.2)
		if gmail_type == None:
			print (" - Getting gmail		[ " + color.RED + "FAILED " + color.END + "]")
		else:
			print (" - Getting gmail		[ " + color.GREEN + "OK " + color.END + "]")


		print ("")
		print (color.BLUE + "[TRACk BY HOZO] " + color.END + "Information Output")
		print ("--------------------------------------")
